...
2. Применить кастомный шрифт для часов;
3. Обеспечить возможность выбирать шрифт для часов;
...
5. В контекстное меню добавить пункт "Pin", который включает/отключает режим "поверх всех окон";
